...
class Result
{
    public const DOCUMENT_TYPE_FAMILY_UNDEFINED = 'UNDEFINED';
    public const DOCUMENT_TYPE_FAMILY_BANK_ACCOUNT = 'BANK_ACCOUNT';
    public const DOCUMENT_TYPE_FAMILY_TAX = 'TAX_DOCUMENT';
    public const DOCUMENT_TYPE_FAMILY_ADDRESS = 'ADDRESS_DOCUMENT';
    public const DOCUMENT_TYPE_FAMILY_PAYSLIP = 'PAYSLIP_DOCUMENT';
    public const DOCUMENT_TYPE_FAMILY_IDENTITY = 'IDENTITY_DOCUMENT';
    public const DOCUMENT_TYPE_FAMILY_VRC = 'VRC_DOCUMENT';
    public const DOCUMENT_TYPE_FAMILY_FAMILY_ALLOWANCE = 'FAMILY_ALLOWANCE_DOCUMENT';
    public const DOCUMENT_TYPE_FAMILY_RETIREMENT_PENSION = 'RETIREMENT_PENSION_DOCUMENT';
    public const DOCUMENT_TYPE_FAMILY_INSURANCE_ATTESTATION = 'INSURANCE_ATTESTATION_DOCUMENT';

    public const DOCUMENT_TYPE_UNDEFINED = 'UNDEFINED';
    public const DOCUMENT_TYPE_TAX_NOTICE = 'TAX_NOTICE';
    public const DOCUMENT_TYPE_TAX_JUSTIFICATION = 'TAX_JUSTIFICATION';
    public const DOCUMENT_TYPE_RIB = 'RIB';
    public const DOCUMENT_TYPE_PROPERTY_TAX_NOTICE = 'PROPERTY_TAX_NOTICE';
    public const DOCUMENT_TYPE_LOCAL_RESIDENCE_TAX_NOTICE = 'LOCAL_RESIDENCE_TAX_NOTICE';
    public const DOCUMENT_TYPE_ENERGY_INVOICE = 'ENERGY_INVOICE';
    public const DOCUMENT_TYPE_ENERGY_SCHEDULE = 'ENERGY_SCHEDULE';
    public const DOCUMENT_TYPE_PHONE_INVOICE = 'PHONE_INVOICE';
    public const DOCUMENT_TYPE_PROVIDER_ATTESTATION = 'PROVIDER_ATTESTATION';
    public const DOCUMENT_TYPE_PAYSLIP = 'PAYSLIP';
    public const DOCUMENT_TYPE_FAMILY_ALLOWANCE = 'FAMILY_ALLOWANCE';
    public const DOCUMENT_TYPE_RETIREMENT_PENSION = 'RETIREMENT_PENSION';
    public const DOCUMENT_TYPE_INSURANCE_ATTESTATION = 'INSURANCE_ATTESTATION';
    ...
    public const DOCUMENT_TYPE_VEHICLE_REGISTRATION_CERTIFICATE = 'VEHICLE_REGISTRATION_CERTIFICATE';
